    ...
    for (const key in next) {
        ...
        if (isMotionValue(nextValue)) {
            ...
            if (process.env.NODE_ENV === "development") {
                motionUtils.warnOnce(nextValue.version === "12.7.4", `Attempting to mix Motion versions ${nextValue.version} with 12.7.4 may not work as expected.`);
            }
        }
...
function createAnimationState(visualElement) {
    ...
    function animateChanges(changedActiveType) {
        ...
        /**
         * A list of animations that we'll b